...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      <a href="vueinscriptionValidation"></a>
      <h3 class="heading">Inscription Validée</h3>
      <br/>
      <img class="resize" src='images/connexion/validation.png'>
    </div>
	<center>
		<p>Vous êtes bien inscrit sur notre site !</p>
		<p>Cliquer sur "Valider" pour retourner sur la page d'accueil !</p>
