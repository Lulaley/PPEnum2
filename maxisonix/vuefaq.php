...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      <img class="resize" src='images/faq/faq.png'>
    </div>
    <center>
	<li> <a href="index.php"> Pourquoi je n'arrive pas à me connecter ? </a></li>
	<li> <a href="index.php"> Quels sont les modes de paiments ? </a></li>
	<li> <a href="index.php"> Pourrais-je payer en plusieurs fois ? </a></li>
	<li> <a href="index.php"> Pourquoi ma commande n'est toujours pas arrivé ? </a></li>
	<li> <a href="index.php"> Comment annuler ma commande ? </a></li>
	<li> <a href="index.php"> Es t-il possible de changer ma commande ? </a></li>
	<li> <a href="index.php"> Ma commande n'est pas bon </a></li>
	<li> <a href="index.php"> Es t-il possible de rendre une commande ? </a></li>
	<li> <a href="index.php"> Je n'ai toujours reçu le remboursement </a></li>
	</center>
    <!-- ################################################################################################ -->
    <!-- / main body -->
    <div class="clear"></div>
