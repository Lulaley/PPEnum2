...
<?php
    ...
    if (isset($_POST["Valider"]))
    {
      $email = $_POST['email'];
      $mdp = $_POST['mdp'];
      $resultat = $unControlleur -> VerifierConnexion($email, $mdp);

      if ($resultat != null && $resultat != false)
      { 
        // echo "<div style='text-align:center'> Bienvenu " .$resultat['MailC'];
        // echo '<script language="Javascript">
        // alert ("Vous êtes connecté !");
        // </script>';
        session_start();
        $_SESSION['idC'] = $resultat['id'];
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <img class="resize" src='images/connexion/connexion.png'>
    </div>
	<form method = "post" action = "">
		<table border = 0>
			<tr><td>Email : </td><td><input type="text" name="email" style="width:820px"></td></tr>
			<tr><td>Mot de passe : </td><td><input type="password" name="mdp" style="width:820px"></td></tr>
		</table>
		<center>
		<tr><td><input type="submit" name="Valider" value = "Connexion" style="width:250px"></td></tr>
		</center>
	</form>
