<center>
	...
	<table border = 0>
		<tr><td><a title="Les caractères spéciaux autorisés (é è à ù ê â ë ä ü ï & ç)">*</a>Prenom : </td><td><input type="text" name="PrenomC" value="<?php if (isset($resultat)) echo $resultat['PrenomC']; ?>" style="width:250px" maxlength="25"></td><br/></tr>
		<tr><td><a title="Les caractères spéciaux autorisés (é è à ù ê â ë ä ü ï & ç)">*</a>Nom : </td><td><input type="text" name="NomC" value="<?php if (isset($resultat)) echo $resultat['NomC']; ?>" style="width:250px" maxlength="25"></td><br/></tr>
	...
	<h2> Compte </h2>
	<table border = 0>
		<tr><td><a title="Insérez un e-mail valide">*</a>Email : </td><td><input type="mail" name="MailC" value="<?php if (isset($resultat)) echo $resultat['MailC']; ?>" style="width:250px" maxlength="25"></td><br/></tr>
	...
	<tr><td><input type="submit" name="ValiderPart" value="Valider" style="width:250px"></td></tr>
