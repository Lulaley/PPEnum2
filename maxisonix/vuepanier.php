  ...
  <main class="hoc container clear"> 
    ...
    <ul class="nospace group center">
      <li class="one_third first">
        <article>
          <h6 class="heading font-x1">Liste d'achat</h6>
          <a class="inverse" href="vueliste"><img class="resizepanier" src='images/panier/liste.png'></a>
        </article>
      </li>
      <li class="one_third">
        <article>
          <h6 class="heading font-x1">Paiement</h6>
          <a class="inverse" href="vuepaiement"><img class="resizepanier" src='images/panier/paiement.png'></a>
        </article>
      </li>
    </ul>
    <!-- ################################################################################################ -->
